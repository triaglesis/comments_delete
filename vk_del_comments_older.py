...
def delete_comments_older(log_file, token, tk_owner_id, tk_group_id, tk_domain, offset):
    ...
    def log_block(message):
        with open(log_file, "a", encoding='utf-8') as f:
            f.write(curr_date+" 5_min_bot -> "+message+"\n")
    ...
    # log_block("5_min Bot has started it's work")
    # log_block("Offset: "+str(offset))
    ...
    if list_of_users:
        ...
        for item in splited:
            ...
            try:
                ...
                log_block("ERROR!!! : Connection ERROR while isMember!")
    else:
    ...
    if list_to_delete:
        # log_block("Bot will delete comments: "+" "*26+str(len(list_to_delete)))
    ...
    # else:
        ...
        # print("Nothing to delete this time"+" "*24+"0")
